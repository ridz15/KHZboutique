...
export const productCollections: { name: string; variants: Omit<Product, "name">[] }[] = [
  {
    name: "Aisyah Abaya",
    variants: [
      { color: "Black", image: "/gallery/A-black.jpg", price: "Rp 199.000" },
      { color: "Brown", image: "/gallery/A-brown.jpg", price: "Rp 199.000" },
      { color: "Grey", image: "/gallery/A-grey.jpg", price: "Rp 199.000" },
      { color: "Maroon", image: "/gallery/A-maroon.jpg", price: "Rp 199.000" },
    ],
  },
  {
    name: "Wulan Kaftan",
    variants: [
      { color: "Maroon", image: "/gallery/kaftan-wulan-maroon.jpg", price: "Rp 199.000" },
      { color: "Purple", image: "/gallery/kaftan-wulan-purple.jpg", price: "Rp 199.000" },
      { color: "White", image: "/gallery/kaftan-wulan-white.jpg", price: "Rp 199.000" },
      { color: "Blue", image: "/gallery/kaftan-wulan-blue.jpg", price: "Rp 199.000" },
    ],
  },
  {
    name: "Nayla Khimar",
